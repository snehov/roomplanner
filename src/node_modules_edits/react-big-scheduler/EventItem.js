...
var EventItem = (_temp = _class = function (_Component) {
    ...
    _createClass(EventItem, [{
        ...
        value: function render() {
            ...
            // paddingLeft is manual edit
            var a = _react2.default.createElement(
                'a',
                { className: 'timeline-event', style: { left: left, width: width, top: top, paddingLeft: config.EVENT_ITEM_HORIZONTAL_EDGE_PADDING, paddingRight: config.EVENT_ITEM_HORIZONTAL_EDGE_PADDING }, onClick: function onClick() {
