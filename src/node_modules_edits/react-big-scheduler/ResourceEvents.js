...
var ResourceEvents = (_temp = _class = function (_Component) {
    ...
    function ResourceEvents(props) {
        ...
        _this.stopDrag = function (ev) {
            ...
            //console.log("stop drag, startTime:", startTime, " endTime:",endTime )  
            ...
            if (config.checkConflict) {
                // manual edit, for no-day views, set custom start-end range time edges
                var start = schedulerData.viewType === 0 ? localeMoment(startTime) : localeMoment(startTime).hour(config.BOOK_TIME_START);
                var end = schedulerData.viewType === 0 ? localeMoment(endTime) : localeMoment(endTime).hour(config.BOOK_TIME_END);
                    console.log(" checkging conflict", startTime, endTime, "BOOK_TIME_START ",config.BOOK_TIME_START, schedulerData.viewType, _index.ViewTypes)
