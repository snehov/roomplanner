...
class Calendar extends Component{
  constructor(props){
    ...
    let schedulerData = new SchedulerData('2017-12-18', ViewTypes.Custom1, false, false, {
        headerEnabled: true,
        customCellWidth: 30,
        nonAgendaDayCellHeaderFormat: 'D. M.',
        
        views: [
            {viewName: 'Cutstom', viewType: ViewTypes.Custom1, showAgenda: false, isEventPerspective: false},
...
render(){
    ...
    return (
        <div>
            <div>
                <h3 style={{textAlign: 'center'}}>Infinite scroll 2</h3>
