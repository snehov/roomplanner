...
class EventItem extends Component {
    ...
    render() {
        ...
        let a = <a className="timeline-event" style={{left: left, width: width, top: top, paddingLeft: config.EVENT_ITEM_HORIZONTAL_EDGE_PADDING, paddingRight: config.EVENT_ITEM_HORIZONTAL_EDGE_PADDING}} onClick={() => { if(!!eventItemClick) eventItemClick(schedulerData, eventItem);}}>
            {eventItemTemplate}
            {startResizeDiv}
            {endResizeDiv}
        </a>;
