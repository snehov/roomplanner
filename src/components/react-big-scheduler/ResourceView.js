...
class ResourceView extends Component {
    ...
    render() {
        ...
        let resourceList = displayRenderData.map((item, rowIndex) => {
            let indents = [];
            ...
            let tdStyle = rowIndex === displayRenderData.length - 1 ? { height: item.rowHeight + tableLastRowAddedHeight } : { height: item.rowHeight };
