...
class Scheduler extends Component {
    ...
    render() {
        ...
        if (showAgenda) {
            ...
            let schedulerContentStyle = {overflow: 'overlay', margin: "0px", position: "relative", paddingBottom: contentPaddingBottom};
                ...
                <tr>
                    ...
                    <td>
                        <div className="scheduler-view" style={{width: schedulerContainerWidth, verticalAlign: 'top'}}>
                            <div style={{overflow: "hidden", borderBottom: "1px solid #e9e9e9", height: config.tableHeaderHeight}}>
                                <div style={{overflowX: "hidden", overflowY: "hidden", margin: `0px 0px -${contentScrollbarHeight}px`}} ref={this.schedulerHeadRef} onMouseOver={this.onSchedulerHeadMouseOver} onMouseOut={this.onSchedulerHeadMouseOut} onScroll={this.onSchedulerHeadScroll}>
...
export default withDragDropContext(Scheduler)